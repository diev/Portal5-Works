    ...
    ) : IApiService
{
    ...
    /// <summary>
    /// 3.1.3.2.1 Для создания нового сообщения используется метод POST<br/>
    /// POST: */messages
    /// </summary>
    ...
    /// <summary>
    /// 3.1.3.2.2 Для создания сессии отправки HTTP используется метод POST<br/>
    ...
    /// <summary>
    /// 3.1.3.2.3 Для отправки файла по HTTP используется метод PUT<br/>
    ...
    /// <summary>
    /// 3.1.3.2.4 Для подтверждения отправки сообщения используется метод POST<br/>
    /// POST: */messages/{msgId}
    /// </summary>
    ...
    /// <summary>
    /// 3.1.3.3.1 Для получения всех сообщений с учетом необязательного фильтра
    ...
    /// <summary>
    /// 3.1.3.3.2 Для получения данных о конкретном сообщении используется метод GET<br/>
    /// GET: */messages/{msgId}
    /// </summary>
    ...
    /// <summary>
    /// 3.1.3.3.3 Для скачивания конкретного сообщения используется метод GET<br/>
    ...
    /// <summary>
    /// 3.1.3.3.4 Для получения данных о конкретном файле используется метод GET<br/>
    ...
    /// <summary>
    /// 3.1.3.3.5 Для скачивания конкретного файла из конкретного сообщения используется метод GET<br/>
    ...
    /// <summary>
    /// 3.1.3.3.6 Для получения данных о квитанциях на сообщение используется метод GET<br/>
    ...
    /// <summary>
    /// 3.1.3.3.7 Для получения данных о квитанции на сообщение используется метод GET<br/>
    ...
    /// <summary>
    /// 3.1.3.3.8 Для получения данных о файле квитанции на сообщение используется метод GET<br/>
    ...
    /// <summary>
    /// 3.1.3.3.9 Для скачивания файла квитанции на сообщение используется метод GET<br/>
    ...
    /// <summary>
    /// 3.1.3.4.1 Для удаления конкретного сообщения используется метод DELETE<br/>
    ...
    /// <summary>
    /// 3.1.3.4.2 Для удаления конкретного файла или отмены сессии отправки используется метод DELETE<br/>
    ...
    /// <summary>
    /// 3.1.3.5.1 Для получения справочника задач используется метод GET<br/>
    /// GET: */tasks
    /// </summary>
    ...
    /// <summary>
    /// 3.1.3.5.2 Для получения информации о своём профиле используется метод GET<br/>
    /// GET: */profile
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// 3.1.3.5.3 Для получения информации о квоте профиля используется метод GET<br/>
    /// GET: */profile/quota
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// 3.1.3.5.4 Для получения информации о технических оповещениях используется метод GET<br/>
    /// GET: */notifications
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// 3.1.3.5.5 Для получения списка справочников используется метод GET<br/>
    /// GET: */dictionaries
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// 3.1.3.5.6 Для получения записей конкретного справочника 1<br/>
    ...
    /// <summary>
    /// 3.1.3.5.6 Для получения записей конкретного справочника 2<br/>
    ...
    /// <summary>
    /// 3.1.3.5.6 Для получения записей конкретного справочника 3<br/>
    ...
    /// <summary>
    /// 3.1.3.5.7 Для скачивания конкретного справочника в виде файла используется метод GET<br/>
