...
/// </summary>
public static class MessageOutStatus
{
    /// <summary>
    ...
    /// <summary>
    /// Доставлено: Сообщение успешно размещено в ЛК/Сообщение передано роутером во внутреннюю систему Банка России, от которой не ожидается ответ о регистрации.
    /// </summary>
    public static string Success => "success";

    public static List<string> Values => new() { "draft", "sent", "delivered", "error", "processing", "registered", "rejected", "success" };
}
