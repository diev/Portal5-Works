...
(
    ...
    /// <summary>
    /// Дата создания сообщения (ГОСТ ISO 8601-2001 по маске «yyyy-MM-dd'T'HH:mm:ss'Z'»).<br/>
    /// Example: "2023-09-25T16:03:31Z"
    /// </summary>
    DateTime CreationDate,

    /// <summary>
    /// Дата последнего изменения статуса сообщения (ГОСТ ISO 8601-2001 по маске «yyyy-MM-dd'T'HH:mm:ss'Z'»).<br/>
    /// Example: null<br/>
