...
Commands:
  ...
  z296   Feeds: Размещение фидов, фидов+
```
...
В программе реализованы по документу "20.02.2026 Описание внешнего
взаимодействия. Технические условия внешнего обмена. Версия 2.5"
все актуальные разделы 3.1.3.1-3.1.3.5.
...
- `Zadacha_296` - Размещение фидов, фидов+
...
Получение последних фидов (`Zadacha_296`): 
