...
public class ConsoleApplicationBuilderSettings
{
    ...
    /// These sources can influence the
    /// <see cref="HostApplicationBuilder.Environment"/>
    /// through the use of <see cref="HostDefaults"/> keys.
    /// Disposing the built <see cref="IHost"/> disposes the
    ...
    /// <see cref="ConsoleApplicationBuilder.Configuration"/>.
    /// </summary>
