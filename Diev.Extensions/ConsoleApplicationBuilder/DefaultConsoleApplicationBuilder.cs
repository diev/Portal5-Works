...
/// <summary>
/// A builder that follows the application builder pattern to create
/// an application object that includes environment and service configuration.
/// </summary>
/// <remarks>
/// HostApplicationBuilder has:
/// <list>
/// <item>- ConfigurationManager Configuration,</item>
/// <item>- ILoggingBuilder Logging,</item>
/// <item>- IMetricsBuilder Metrics,</item>
/// <item>- IServiceCollection Services.</item>
/// </list>
/// WebApplicationBuilder has:
/// <list>
/// <item>- ConfigurationManager Configuration,</item>
/// <item>- ILoggingBuilder Logging,</item>
/// <item>- IMetricsBuilder Metrics,</item>
...
internal class DefaultConsoleApplicationBuilder : IConsoleApplicationBuilder
{
    ...
    public DefaultConsoleApplicationBuilder(ConsoleApplicationBuilderSettings settings)
    {
        ...
        {
            // Call _configureContainer in case anyone adds callbacks
            // via DefaultConsoleApplicationBuilder.ConfigureContainer<IServiceCollection>() during build.
    ...
    public void ConfigureContainer<TBuilder>(IServiceProviderFactory<TBuilder> factory, Action<TBuilder>? configure = null) where TBuilder : notnull
    {
        createServiceProvider = () =>
        {
            ...
            // Call _configureContainer in case anyone adds more callbacks
            // via HostBuilderAdapter.ConfigureContainer<TContainerBuilder>() during build.
        ...
        // Store _configureContainer separately so it can be replaced
        // individually by the HostBuilderAdapter.
