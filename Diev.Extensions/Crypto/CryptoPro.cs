...
public static class CryptoPro
{
    ...
    /// </summary>
    public static string My { get; set; } = null!;
    ...
    /// {2} - отпечаток своего сертификата.
    /// </summary>
    public static string EncryptCommand { get; set; } = "-sfenc -encrypt -silent -in {0} -out {1} -cert {2}"; // -stream -1215gh
    ...
    */
    ...
    {
        await SignFileAsync(file, resultFile, My, PIN);
    }

    public static async Task SignFileAsync(string file, string resultFile, string my, string? pin = null)
    {
    ...
    {
        await SignDetachedFileAsync(file, resultFile, My, PIN);
    }

    public static async Task SignDetachedFileAsync(string file, string resultFile, string my, string? pin = null)
    {
    ...
    {
        return await VerifyFileAsync(file, resultFile, My);
    }

    public static async Task<bool> VerifyFileAsync(string file, string resultFile, string my)
    {
        if (my is null)
        {
    ...
    {
        return await VerifyDetachedFileAsync(file, signFile, My);
    }

    public static async Task<bool> VerifyDetachedFileAsync(string file, string signFile, string my)
    {
        if (my is null)
        {
            throw new ApplicationException("My cert thumbprint required.");
    ...
    /// <exception cref="FileNotFoundException"></exception>
    public static async Task EncryptFileAsync(string file, string resultFile, string[]? to = null)
    {
        await EncryptFileAsync(file, resultFile, My, to);
    }

    public static async Task EncryptFileAsync(string file, string resultFile, string my, string[]? to = null)
    {
    ...
    {
        await DecryptFileAsync(file, resultFile, My, PIN);
    }

    public static async Task DecryptFileAsync(string file, string resultFile, string my, string? pin = null)
    {
